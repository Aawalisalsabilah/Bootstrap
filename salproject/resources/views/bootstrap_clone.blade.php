    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        ...
        <div class="container py-2 px-4">
            ...
            <a href="#" class="navbar-brand mb-0 h1">
                <img src="{{ asset('assets/images/logo-white.svg') }}" class="img-fluid" style="width: 40px;">
            </a>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-2">
                    <img src="{{ asset('assets/images/main.svg') }}" class="img-fluid">
                </div>
    ...
    <div id="bs-icons">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('assets/images/bs-icons.png') }}" class="img-fluid" alt="Bootstrap Icons">
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="bs-themes">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('assets/images/bs-themes.png') }}" class="img-fluid" alt="Bootstrap Themes">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="#" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img src="{{ asset('assets/images/logo-black.svg') }}" class="img-fluid"
