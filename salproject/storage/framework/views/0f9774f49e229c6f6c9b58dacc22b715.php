...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <a href="<?php echo e(url('/bootstrap_clone')); ?>" class="list-group-item list-group-item-action">Bootstrap Clone Page</a>
        </div>
    </div>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/app.js'); ?>
</body>
</html>
<?php /**PATH C:\Users\aawal\salproject\resources\views/routing.blade.php ENDPATH**/ ?>